<template>
  <div>
    <h1 class="title">影院</h1>
    <el-row class="local-bg">
      <el-col :span="5" class="localCity"><router-link to="/city" tag="div">{{localCity.nm}}<i class="iconfont icon-xiajiantoushixinxiao"></i></router-link></el-col>
      <el-col :span="19">
